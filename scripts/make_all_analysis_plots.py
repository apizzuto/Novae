import argparse
from plotting import StackingPlots, GammaCatalog, GammaRayNova, GRECOPlots, SynthesisPlots
...
if __name__ == '__main__':
    ...
    print(f"\t Min log10(E): None (not tested for stacking), \t All flavor: {args.allflavor}")
    ...
    print(f"\t Min log10(E): {args.minLogE:.1f}, \t All flavor: {args.allflavor}")
    print(f"\t Figures will be saved to {args.output_path}")
    gplots = GRECOPlots(min_log_e=args.minLogE, 
        allflavor=args.allflavor, save=True)
