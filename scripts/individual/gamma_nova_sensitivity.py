...
greco_ana = cy.get_analysis(cy.selections.repo,
    'version-002-p10',
...
try:
    ...
    print(f"Only {len(gamma_df)} novae to choose from" \
...
output_loc = f"/data/user/apizzuto/Nova/csky_trials/nova_{nova_ind}_{name}_delta_t_{delta_t_str}_gamma_{args.index}_trials.pkl"
